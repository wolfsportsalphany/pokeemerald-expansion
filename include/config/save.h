...
#define FREE_MYSTERY_EVENT_BUFFERS          TRUE    // SAG: unused; frees ramScript (1104 bytes) for the bag.
#define FREE_MATCH_CALL                     FALSE   // Frees up match call and rematch / VS Seeker data. (104 bytes).
#define FREE_UNION_ROOM_CHAT                TRUE    // SAG: unused; frees union room chat (212 bytes).
...
#define FREE_MYSTERY_GIFT                   TRUE    // SAG: unused; frees Mystery Gift data (876 bytes).
