...
{
    { SPECIES_AERODACTYL, { MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_DRAGON_DANCE } },
    { SPECIES_ALAKAZAM, { MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_FOCUS_BLAST, MOVE_NASTY_PLOT } },
    { SPECIES_AMPHAROS, { MOVE_THUNDERBOLT, MOVE_DRAGON_PULSE, MOVE_POWER_GEM, MOVE_VOLT_SWITCH } },
    { SPECIES_ARBOK, { MOVE_GUNK_SHOT, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_SUCKER_PUNCH } },
    { SPECIES_ARCANINE, { MOVE_FLARE_BLITZ, MOVE_WILD_CHARGE, MOVE_EXTREME_SPEED, MOVE_CLOSE_COMBAT } },
    { SPECIES_ARTICUNO, { MOVE_ICE_BEAM, MOVE_HURRICANE, MOVE_FREEZE_DRY, MOVE_ROOST } },
    { SPECIES_BLASTOISE, { MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_FLASH_CANNON, MOVE_AURA_SPHERE } },
    { SPECIES_CHARIZARD, { MOVE_FLAMETHROWER, MOVE_AIR_SLASH, MOVE_DRAGON_PULSE, MOVE_SOLAR_BEAM } },
    { SPECIES_CLOYSTER, { MOVE_ICICLE_SPEAR, MOVE_ROCK_BLAST, MOVE_SHELL_SMASH, MOVE_HYDRO_PUMP } },
    { SPECIES_DEWGONG, { MOVE_SURF, MOVE_ICE_BEAM, MOVE_SIGNAL_BEAM, MOVE_REST } },
    { SPECIES_DODRIO, { MOVE_BRAVE_BIRD, MOVE_BODY_SLAM, MOVE_KNOCK_OFF, MOVE_SWORDS_DANCE } },
    { SPECIES_DONPHAN, { MOVE_EARTHQUAKE, MOVE_ICE_SHARD, MOVE_RAPID_SPIN, MOVE_STEALTH_ROCK } },
    { SPECIES_ELECTIVIRE, { MOVE_WILD_CHARGE, MOVE_ICE_PUNCH, MOVE_EARTHQUAKE, MOVE_CROSS_CHOP } },
    { SPECIES_EXEGGUTOR, { MOVE_PSYCHIC, MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER } },
    { SPECIES_FEAROW, { MOVE_BRAVE_BIRD, MOVE_DRILL_RUN, MOVE_RETURN, MOVE_QUICK_ATTACK } },
    { SPECIES_GIRAFARIG, { MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_NASTY_PLOT, MOVE_SHADOW_BALL } },
    { SPECIES_GOLDUCK, { MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_NASTY_PLOT } },
    { SPECIES_GOLEM, { MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_SUCKER_PUNCH, MOVE_STEALTH_ROCK } },
    { SPECIES_GRANBULL, { MOVE_PLAY_ROUGH, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_BULK_UP } },
    { SPECIES_GYARADOS, { MOVE_WATERFALL, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE } },
    { SPECIES_HERACROSS, { MOVE_MEGAHORN, MOVE_CLOSE_COMBAT, MOVE_STONE_EDGE, MOVE_SWORDS_DANCE } },
    { SPECIES_HOUNDOOM, { MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_SLUDGE_BOMB, MOVE_NASTY_PLOT } },
    { SPECIES_KANGASKHAN, { MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_SUCKER_PUNCH, MOVE_POWER_UP_PUNCH } },
    { SPECIES_KINGDRA, { MOVE_HYDRO_PUMP, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_FLASH_CANNON } },
    { SPECIES_KINGLER, { MOVE_CRABHAMMER, MOVE_X_SCISSOR, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE } },
    { SPECIES_MACHAMP, { MOVE_DYNAMIC_PUNCH, MOVE_KNOCK_OFF, MOVE_STONE_EDGE, MOVE_BULLET_PUNCH } },
    { SPECIES_MAGMORTAR, { MOVE_FLAMETHROWER, MOVE_THUNDERBOLT, MOVE_FOCUS_BLAST, MOVE_PSYCHIC } },
    { SPECIES_MAGNEZONE, { MOVE_THUNDERBOLT, MOVE_FLASH_CANNON, MOVE_VOLT_SWITCH, MOVE_TRI_ATTACK } },
    { SPECIES_MANTINE, { MOVE_SCALD, MOVE_AIR_SLASH, MOVE_ICE_BEAM, MOVE_ROOST } },
    { SPECIES_MAROWAK, { MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_FIRE_PUNCH, MOVE_SWORDS_DANCE } },
    { SPECIES_MOLTRES, { MOVE_FLAMETHROWER, MOVE_HURRICANE, MOVE_SOLAR_BEAM, MOVE_ROOST } },
    { SPECIES_NIDOKING, { MOVE_EARTH_POWER, MOVE_SLUDGE_WAVE, MOVE_ICE_BEAM, MOVE_THUNDERBOLT } },
    { SPECIES_NINETALES, { MOVE_FLAMETHROWER, MOVE_NASTY_PLOT, MOVE_SOLAR_BEAM, MOVE_DARK_PULSE } },
    { SPECIES_OCTILLERY, { MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_FIRE_BLAST, MOVE_ENERGY_BALL } },
    { SPECIES_PIDGEOT, { MOVE_HURRICANE, MOVE_HEAT_WAVE, MOVE_HYPER_BEAM, MOVE_ROOST } },
    { SPECIES_PINSIR, { MOVE_X_SCISSOR, MOVE_CLOSE_COMBAT, MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE } },
    { SPECIES_RAICHU, { MOVE_THUNDERBOLT, MOVE_SURF, MOVE_NASTY_PLOT, MOVE_VOLT_SWITCH } },
    { SPECIES_RAPIDASH, { MOVE_FLARE_BLITZ, MOVE_WILD_CHARGE, MOVE_MEGAHORN, MOVE_MORNING_SUN } },
    { SPECIES_RHYPERIOR, { MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_MEGAHORN, MOVE_SWORDS_DANCE } },
    { SPECIES_SANDSLASH, { MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE, MOVE_X_SCISSOR } },
    { SPECIES_SCIZOR, { MOVE_BULLET_PUNCH, MOVE_X_SCISSOR, MOVE_SWORDS_DANCE, MOVE_ROOST } },
    { SPECIES_SNORLAX, { MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_CURSE } },
    { SPECIES_STARMIE, { MOVE_HYDRO_PUMP, MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_THUNDERBOLT } },
    { SPECIES_STEELIX, { MOVE_EARTHQUAKE, MOVE_IRON_HEAD, MOVE_STONE_EDGE, MOVE_STEALTH_ROCK } },
    { SPECIES_SUDOWOODO, { MOVE_WOOD_HAMMER, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_SUCKER_PUNCH } },
    { SPECIES_SUICUNE, { MOVE_SCALD, MOVE_ICE_BEAM, MOVE_CALM_MIND, MOVE_REST } },
    { SPECIES_TANGROWTH, { MOVE_POWER_WHIP, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_GIGA_DRAIN } },
    { SPECIES_TAUROS, { MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_IRON_HEAD } },
    ...
    { SPECIES_VENUSAUR, { MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER, MOVE_LEECH_SEED } },
    { SPECIES_WEAVILE, { MOVE_KNOCK_OFF, MOVE_ICE_PUNCH, MOVE_ICE_SHARD, MOVE_SWORDS_DANCE } },
    { SPECIES_ZAPDOS, { MOVE_THUNDERBOLT, MOVE_HEAT_WAVE, MOVE_HURRICANE, MOVE_ROOST } },
};
