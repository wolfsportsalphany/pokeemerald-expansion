...
static const struct { u16 species; u16 moves[MAX_MON_MOVES]; } sWildCompMoves[] =
{
    ...
    { SPECIES_BULBASAUR, { MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER, MOVE_LEECH_SEED } },
    { SPECIES_CHARIZARD, { MOVE_FLAMETHROWER, MOVE_AIR_SLASH, MOVE_DRAGON_PULSE, MOVE_SOLAR_BEAM } },
    { SPECIES_CHARMANDER, { MOVE_FLAMETHROWER, MOVE_AIR_SLASH, MOVE_DRAGON_PULSE, MOVE_SOLAR_BEAM } },
    ...
    { SPECIES_GROWLITHE, { MOVE_FLARE_BLITZ, MOVE_WILD_CHARGE, MOVE_EXTREME_SPEED, MOVE_CLOSE_COMBAT } },
    ...
    { SPECIES_HOUNDOUR, { MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_SLUDGE_BOMB, MOVE_NASTY_PLOT } },
    { SPECIES_KADABRA, { MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_FOCUS_BLAST, MOVE_NASTY_PLOT } },
    ...
    { SPECIES_LARVITAR, { MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE } },
    { SPECIES_MACHAMP, { MOVE_DYNAMIC_PUNCH, MOVE_KNOCK_OFF, MOVE_STONE_EDGE, MOVE_BULLET_PUNCH } },
    { SPECIES_MACHOKE, { MOVE_DYNAMIC_PUNCH, MOVE_KNOCK_OFF, MOVE_STONE_EDGE, MOVE_BULLET_PUNCH } },
    { SPECIES_MACHOP, { MOVE_DYNAMIC_PUNCH, MOVE_KNOCK_OFF, MOVE_STONE_EDGE, MOVE_BULLET_PUNCH } },
    { SPECIES_MAGMORTAR, { MOVE_FLAMETHROWER, MOVE_THUNDERBOLT, MOVE_FOCUS_BLAST, MOVE_PSYCHIC } },
    { SPECIES_MAGNETON, { MOVE_THUNDERBOLT, MOVE_FLASH_CANNON, MOVE_VOLT_SWITCH, MOVE_TRI_ATTACK } },
    { SPECIES_MAGNEZONE, { MOVE_THUNDERBOLT, MOVE_FLASH_CANNON, MOVE_VOLT_SWITCH, MOVE_TRI_ATTACK } },
    { SPECIES_MAREEP, { MOVE_THUNDERBOLT, MOVE_DRAGON_PULSE, MOVE_POWER_GEM, MOVE_VOLT_SWITCH } },
    ...
    { SPECIES_PHANPY, { MOVE_EARTHQUAKE, MOVE_ICE_SHARD, MOVE_RAPID_SPIN, MOVE_STEALTH_ROCK } },
    { SPECIES_PINSIR, { MOVE_X_SCISSOR, MOVE_CLOSE_COMBAT, MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE } },
    { SPECIES_PONYTA, { MOVE_FLARE_BLITZ, MOVE_WILD_CHARGE, MOVE_MEGAHORN, MOVE_MORNING_SUN } },
    { SPECIES_PUPITAR, { MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE } },
    ...
    { SPECIES_SCYTHER, { MOVE_BULLET_PUNCH, MOVE_X_SCISSOR, MOVE_SWORDS_DANCE, MOVE_ROOST } },
    { SPECIES_SEADRA, { MOVE_HYDRO_PUMP, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_FLASH_CANNON } },
    { SPECIES_SKARMORY, { MOVE_BRAVE_BIRD, MOVE_STEEL_WING, MOVE_ROOST, MOVE_SPIKES } },
    { SPECIES_SNORLAX, { MOVE_BODY_SLAM, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_CURSE } },
    { SPECIES_SQUIRTLE, { MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_FLASH_CANNON, MOVE_AURA_SPHERE } },
    ...
    { SPECIES_URSARING, { MOVE_FACADE, MOVE_CLOSE_COMBAT, MOVE_CRUNCH, MOVE_SWORDS_DANCE } },
